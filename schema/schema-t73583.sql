...
CREATE TABLE `c_loanapplication` (
  ...
  `paymentcycle` enum('DAILY','WEEKLY','MONTHLY','WHEN_DUE','MONTHLY_MATCH_DAY','MONTHLY_ON_SPECIFIC_DAY','SPECIFIC_DAY') DEFAULT NULL,
  ...
  `interestRecognitionMethod` varchar(45) DEFAULT NULL,
  `interestPeriodCount` decimal(10,2) DEFAULT NULL,
  `totalFees` decimal(10,2) DEFAULT '0.00',
  `settlementDraft` int DEFAULT NULL,
  `penaltyCalcApproach` varchar(45) DEFAULT 'PENALTY_CALC_ON_INSTALLMENT_BALANCE',
  ...
  `upfrontPrincipalPayment` decimal(10,2) DEFAULT '0.00',
  `workingPrincipal` decimal(10,2) DEFAULT '0.00',
  `principalAddition` decimal(10,2) DEFAULT '0.00',
  `childLoanNo` varchar(20) DEFAULT NULL,
  `nextLoanRefId` varchar(45) DEFAULT NULL,
  `loanVersion` enum('V1','V2') NOT NULL DEFAULT 'V2',
  `loanStatus` enum('OPEN','CLOSED') DEFAULT 'OPEN',
  ...
  `loan_sys_version` char(2) DEFAULT 'V2',
  `normal_loan_id` int DEFAULT NULL,
  `consolidated_loanid` int DEFAULT NULL,
  `consolidationAction` varchar(45) DEFAULT NULL,
  `interesttype` varchar(20) DEFAULT 'RATE',
  `tenant_id` varchar(10) DEFAULT NULL,
  `tenant_pid` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `refId_UNIQUE` (`refId`),
  ...
  KEY `fk_c_loanapplication_consolidated_loanid_idx` (`consolidated_loanid`),
  CONSTRAINT `fk_c_loanapplication_consolidated_loanid` FOREIGN KEY (`consolidated_loanid`) REFERENCES `c_loanapplication` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=7310 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=108856 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `c_payment` (
  ...
  `groupRefId` varchar(20) DEFAULT NULL,
  `transactionReference` varchar(45) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=6252 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gl_account` (
  ...
  KEY `fk_gl_account_userid_idx` (`userid`),
  KEY `fk_gl_account_userid` (`userid`),
  CONSTRAINT `fk_gl_account_userid` FOREIGN KEY (`userid`) REFERENCES `gl_account` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5239 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `c_memo` (
  ...
  `destinationAccount` varchar(25) DEFAULT NULL,
  ...
  KEY `fk_c_memo_user_categoryid` (`customercategoryid`),
  CONSTRAINT `fk_c_memo_user_categoryid` FOREIGN KEY (`customercategoryid`) REFERENCES `b_user_category` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2935 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `c_journaltransaction` (
  ...
  `transactionId` varchar(45) DEFAULT NULL,
  `loanid` int DEFAULT NULL,
  `reversedBy` varchar(45) DEFAULT NULL,
...
CREATE TABLE `c_loan_disbursement` (
  ...
  `tenant_pid` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_c_loan_disbursement_idx` (`loanId`),
  CONSTRAINT `fk_c_loan_disbursement_id_map_loan` FOREIGN KEY (`loanId`) REFERENCES `c_loanapplication` (`id`)
...
CREATE TABLE `c_loan_offset_request` (
  ...
  `reversalPostingDate` varchar(45) DEFAULT NULL,
...
CREATE TABLE `c_loan_payment` (
  ...
  `paymentMethod` varchar(45) DEFAULT NULL,
  `postingDate` datetime DEFAULT NULL,
  `balanceAfterAllocations` decimal(10,2) DEFAULT NULL,
  ...
  `tenant_pid` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_c_loan_payment_loanid` (`loanid`),
  KEY `fk_c_loan_payment_journalid` (`journaltransactionid`),
...
CREATE TABLE `c_loanapplication_fees` (
  ...
  `balancebroughtforward` decimal(10,2) DEFAULT NULL,
  ...
  KEY `fk_c_loanapplication_fees_quotationid` (`quotationId`),
...
) ENGINE=InnoDB AUTO_INCREMENT=12354 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `c_loanpenaltycontract` (
  ...
  `penaltyInterval` int DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `refId_UNIQUE` (`refId`),
  KEY `fk_c_loanpenalties_loanid_idx` (`loanid`),
  KEY `fk_c_loanpenalties_loanid` (`loanid`),
  KEY `fk_c_loanpenaltycontract_scheduleid` (`loanscheduleid`),
  KEY `fk_c_loanpenaltycontract_penaltyfee` (`penaltyFeeId`),
  CONSTRAINT `fk_c_loanpenalties_loanid` FOREIGN KEY (`loanid`) REFERENCES `c_loanapplication` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=9509 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `c_penaltyexecution` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `refId_UNIQUE` (`refId`),
  KEY `fk_c_penaltyexecution_loanid_idx` (`loanid`),
  ...
  KEY `fk_c_penaltyexecution_scheduleid` (`loanscheduleId`),
  KEY `fk_c_penaltyexecution_feeid` (`feeId`),
  ...
  CONSTRAINT `fk_c_penaltyexecution_scheduleid` FOREIGN KEY (`loanscheduleId`) REFERENCES `c_loanpaymentschedule` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1149 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=43156 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7515 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `c_membercontribution_deduction`
--

DROP TABLE IF EXISTS `c_membercontribution_deduction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `c_membercontribution_deduction` (
  `id` int NOT NULL AUTO_INCREMENT,
  `refId` varchar(45) NOT NULL,
  `created` datetime DEFAULT NULL,
  `createdBy` varchar(45) DEFAULT NULL,
  ...
  `updatedBy` varchar(45) DEFAULT NULL,
  `isActive` tinyint NOT NULL DEFAULT '1',
  `commonTransactionId` varchar(45) NOT NULL,
  `sourceAccountNumber` varchar(45) NOT NULL,
  `destinationAccountNumber` varchar(45) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `refId_UNIQUE` (`refId`),
  KEY `c_membercontribution_deduction_FK` (`customer_id`),
  KEY `c_membercontribution_deduction_FK_1` (`currency_id`),
  CONSTRAINT `c_membercontribution_deduction_FK` FOREIGN KEY (`customer_id`) REFERENCES `b_user` (`id`),
  CONSTRAINT `c_membercontribution_deduction_FK_1` FOREIGN KEY (`currency_id`) REFERENCES `c_currency` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `c_shares_deduction`
--

DROP TABLE IF EXISTS `c_shares_deduction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `c_shares_deduction` (
  `id` int NOT NULL AUTO_INCREMENT,
  `refId` varchar(45) NOT NULL,
  `created` datetime DEFAULT NULL,
  `createdBy` varchar(45) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `refId_UNIQUE` (`refId`),
  KEY `c_shares_deduction_FK` (`customer_id`),
  KEY `c_shares_deduction_FK_1` (`currency_id`),
  CONSTRAINT `c_shares_deduction_FK` FOREIGN KEY (`customer_id`) REFERENCES `b_user` (`id`),
  CONSTRAINT `c_shares_deduction_FK_1` FOREIGN KEY (`currency_id`) REFERENCES `c_currency` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `c_loan_journal`
--

DROP TABLE IF EXISTS `c_loan_journal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `c_loan_journal` (
  `id` int NOT NULL AUTO_INCREMENT,
  `refId` varchar(45) NOT NULL,
  `created` datetime DEFAULT NULL,
  `createdBy` varchar(45) DEFAULT NULL,
  ...
  `debit_acc_id` int NOT NULL,
  `credit_acc_id` int NOT NULL,
  `amount` decimal(19,4) NOT NULL,
  `status` varchar(45) NOT NULL DEFAULT 'DRAFT',
  `description` varchar(200) DEFAULT NULL,
  `transactionId` varchar(45) NOT NULL,
  `transactionReference` varchar(45) NOT NULL,
  `parentAccountNo` varchar(45) NOT NULL,
  `parentAccountName` varchar(45) NOT NULL,
  `executedBy` varchar(255) DEFAULT NULL,
  `reversalTransactionId` varchar(45) DEFAULT NULL,
  `reversedBy` varchar(125) DEFAULT NULL,
  `reversalPostingDate` datetime DEFAULT NULL,
  `reversalDescription` varchar(125) DEFAULT NULL,
  `tenant_id` varchar(10) DEFAULT NULL,
  `tenant_pid` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `refId_UNIQUE` (`refId`),
  KEY `c_loan_journal_FK_dr_account` (`debit_acc_id`),
  KEY `c_loan_journal_FK_cr_account` (`credit_acc_id`),
  KEY `fk_c_loan_journal_loanid_idx` (`loanid`),
  KEY `fk_c_loan_journal_paymentid_idx` (`paymentid`),
  CONSTRAINT `c_loan_journal_FK_cr_account` FOREIGN KEY (`credit_acc_id`) REFERENCES `gl_account` (`id`),
  CONSTRAINT `c_loan_journal_FK_dr_account` FOREIGN KEY (`debit_acc_id`) REFERENCES `gl_account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_c_loan_journal_loanid` FOREIGN KEY (`loanid`) REFERENCES `c_loanapplication` (`id`),
  CONSTRAINT `fk_c_loan_journal_paymentid` FOREIGN KEY (`paymentid`) REFERENCES `c_loan_payment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `c_loanpaymentschedule_allocation`
--

DROP TABLE IF EXISTS `c_loanpaymentschedule_allocation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `c_loanpaymentschedule_allocation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `refId` varchar(45) NOT NULL,
  `created` datetime DEFAULT NULL,
  `createdBy` varchar(45) DEFAULT NULL,
  ...
  `updatedBy` varchar(45) DEFAULT NULL,
  `isActive` tinyint(1) DEFAULT NULL,
  `allocationFeeType` enum('APPLICATION_FEES','INTEREST_CHARGE','PROCESSING_FEES','PAYMENT_PROVIDER_FEES','PRESTA_SERVICE_CHARGE','PRINCIPLE','PENALTIES') DEFAULT NULL,
  `amount` double(10,2) DEFAULT NULL,
  `paymentStatus` enum('PAID','PARTIALLYPAID','BRIDGED','NOTPAID') DEFAULT NULL,
  `balance` double(10,2) DEFAULT NULL,
  `loanRepaymentScheduleId` int DEFAULT NULL,
  `weight` int DEFAULT NULL,
  `tenant_id` varchar(10) DEFAULT NULL,
  `tenant_pid` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `refId_UNIQUE` (`refId`),
  KEY `fk_repaymentschedule_alloc_repaymentmentschedule_idx` (`loanRepaymentScheduleId`),
  CONSTRAINT `fk_repaymentschedule_alloc_repaymentmentschedule` FOREIGN KEY (`loanRepaymentScheduleId`) REFERENCES `c_loanpaymentschedule` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=738417 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-07-13 13:18:15
